...
main(int argc, char *argv[])
{
  ...
  trace(1);
  11:	6a 01                	push   $0x1
  13:	e8 4b 03 00 00       	call   363 <trace>
  int fd = open("README", 0);
  18:	58                   	pop    %eax
  19:	5a                   	pop    %edx
  1a:	6a 00                	push   $0x0
  1c:	68 48 07 00 00       	push   $0x748
  21:	e8 dd 02 00 00       	call   303 <open>
  close(fd);
  26:	89 04 24             	mov    %eax,(%esp)
  29:	e8 bd 02 00 00       	call   2eb <close>
  printf(1, "Hello World\n");
  2e:	59                   	pop    %ecx
  2f:	58                   	pop    %eax
  30:	68 4f 07 00 00       	push   $0x74f
  35:	6a 01                	push   $0x1
  37:	e8 e4 03 00 00       	call   420 <printf>
  
  trace(0);
  3c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  43:	e8 1b 03 00 00       	call   363 <trace>
  int fd1 = open("README", 0);
  48:	58                   	pop    %eax
  49:	5a                   	pop    %edx
  4a:	6a 00                	push   $0x0
  4c:	68 48 07 00 00       	push   $0x748
  51:	e8 ad 02 00 00       	call   303 <open>
  close(fd1);
  56:	89 04 24             	mov    %eax,(%esp)
  59:	e8 8d 02 00 00       	call   2eb <close>
  exit();
