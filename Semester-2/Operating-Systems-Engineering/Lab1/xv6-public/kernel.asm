...
80103814:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
8010381a:	e8 41 0d 00 00       	call   80104560 <release>
...
8010383c:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010383f:	c7 40 14 e4 58 10 80 	movl   $0x801058e4,0x14(%eax)
  p->context = (struct context*)sp;
...
8010384e:	e8 2d 0e 00 00       	call   80104680 <memset>
...
8010387a:	e8 e1 0c 00 00       	call   80104560 <release>
}
...
801038f6:	68 60 77 10 80       	push   $0x80107760
...
801039d3:	e8 f8 34 00 00       	call   80106ed0 <setupkvm>
...
801039f1:	e8 8a 31 00 00       	call   80106b80 <inituvm>
...
80103a5f:	68 90 77 10 80       	push   $0x80107790
80103a64:	50                   	push   %eax
80103a65:	e8 d6 0d 00 00       	call   80104840 <safestrcpy>
  p->cwd = namei("/");
80103a6a:	c7 04 24 99 77 10 80 	movl   $0x80107799,(%esp)
...
80103aa3:	68 77 77 10 80       	push   $0x80107777
...
80103adb:	e8 90 2f 00 00       	call   80106a70 <switchuvm>
  return 0;
...
80103b68:	e8 53 34 00 00       	call   80106fc0 <copyuvm>
...
80103cb2:	e8 e4 0b 00 00       	call   8010489b <swtch>
      switchkvm();
80103cb7:	e8 a4 2d 00 00       	call   80106a60 <switchkvm>
      c->proc = 0;
...
80103ec7:	68 e8 77 10 80       	push   $0x801077e8
80103ecc:	e8 af c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ed1:	83 ec 0c             	sub    $0xc,%esp
80103ed4:	68 db 77 10 80       	push   $0x801077db
...
80103fa9:	e8 a2 2e 00 00       	call   80106e50 <freevm>
        p->pid = 0;
...
80104000:	68 f4 77 10 80       	push   $0x801077f4
...
80104109:	68 fa 77 10 80       	push   $0x801077fa
8010410e:	e8 6d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104113:	83 ec 0c             	sub    $0xc,%esp
80104116:	68 f4 77 10 80       	push   $0x801077f4
...
8010421b:	68 77 7c 10 80       	push   $0x80107c77
...
8010423f:	74 e7                	je     80104228 <procdump+0x28>
      state = "???";
80104241:	ba 0b 78 10 80       	mov    $0x8010780b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104246:	83 f8 05             	cmp    $0x5,%eax
80104249:	77 11                	ja     8010425c <procdump+0x5c>
8010424b:	8b 14 85 6c 78 10 80 	mov    -0x7fef8794(,%eax,4),%edx
      state = "???";
80104252:	b8 0b 78 10 80       	mov    $0x8010780b,%eax
...
80104261:	68 0f 78 10 80       	push   $0x8010780f
...
8010429d:	68 61 72 10 80       	push   $0x80107261
...
801042ca:	68 84 78 10 80       	push   $0x80107884
...
8010457b:	68 ad 78 10 80       	push   $0x801078ad
...
80104a8f:	8b 70 1c             	mov    0x1c(%eax),%esi
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104a92:	8d 46 ff             	lea    -0x1(%esi),%eax
80104a95:	83 f8 15             	cmp    $0x15,%eax
80104a98:	77 66                	ja     80104b00 <syscall+0x80>
80104a9a:	8b 04 b5 e0 79 10 80 	mov    -0x7fef8620(,%esi,4),%eax
80104aa1:	85 c0                	test   %eax,%eax
80104aa3:	74 5b                	je     80104b00 <syscall+0x80>
    curproc->tf->eax = syscalls[num]();
80104aa5:	ff d0                	call   *%eax
80104aa7:	8b 53 18             	mov    0x18(%ebx),%edx
80104aaa:	89 42 1c             	mov    %eax,0x1c(%edx)
    if(curproc->tracing) {
80104aad:	8b 43 7c             	mov    0x7c(%ebx),%eax
80104ab0:	85 c0                	test   %eax,%eax
80104ab2:	74 6b                	je     80104b1f <syscall+0x9f>
        cprintf("pid: %d [%s] syscall (%d=%s) \n", curproc->pid, curproc->name, num, syscallNames[num]);
80104ab4:	83 ec 0c             	sub    $0xc,%esp
80104ab7:	8d 43 6c             	lea    0x6c(%ebx),%eax
80104aba:	ff 34 b5 80 79 10 80 	push   -0x7fef8680(,%esi,4)
80104ac1:	56                   	push   %esi
80104ac2:	50                   	push   %eax
80104ac3:	ff 73 10             	push   0x10(%ebx)
80104ac6:	68 c0 78 10 80       	push   $0x801078c0
80104acb:	e8 d0 bb ff ff       	call   801006a0 <cprintf>
        curproc->syscallcount++; 
80104ad0:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
        cprintf("System call count: %d\n", curproc->syscallcount);
80104ad6:	83 c4 18             	add    $0x18,%esp
        curproc->syscallcount++; 
80104ad9:	83 c0 01             	add    $0x1,%eax
80104adc:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
        cprintf("System call count: %d\n", curproc->syscallcount);
80104ae2:	50                   	push   %eax
80104ae3:	68 df 78 10 80       	push   $0x801078df
80104ae8:	e8 b3 bb ff ff       	call   801006a0 <cprintf>
...
80104b08:	68 f6 78 10 80       	push   $0x801078f6
...
80104b47:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104b4a:	e8 71 d5 ff ff       	call   801020c0 <nameiparent>
...
80104b60:	e8 1b cc ff ff       	call   80101780 <ilock>
...
80104b6c:	e8 6f d1 ff ff       	call   80101ce0 <dirlookup>
...
80104b86:	e8 f5 cb ff ff       	call   80101780 <ilock>
...
80104bda:	e8 31 ca ff ff       	call   80101610 <ialloc>
...
80104c11:	e8 ba ca ff ff       	call   801016d0 <iupdate>
...
80104c28:	e8 b3 d3 ff ff       	call   80101fe0 <dirlink>
...
80104c59:	e8 72 ca ff ff       	call   801016d0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104c5e:	83 c4 0c             	add    $0xc,%esp
80104c61:	ff 76 04             	push   0x4(%esi)
80104c64:	68 58 7a 10 80       	push   $0x80107a58
80104c69:	56                   	push   %esi
80104c6a:	e8 71 d3 ff ff       	call   80101fe0 <dirlink>
...
80104c7c:	68 57 7a 10 80       	push   $0x80107a57
80104c81:	56                   	push   %esi
80104c82:	e8 59 d3 ff ff       	call   80101fe0 <dirlink>
...
80104c91:	68 4b 7a 10 80       	push   $0x80107a4b
...
80104caf:	68 5a 7a 10 80       	push   $0x80107a5a
80104cb4:	e8 c7 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104cb9:	83 ec 0c             	sub    $0xc,%esp
80104cbc:	68 3c 7a 10 80       	push   $0x80107a3c
...
80104cde:	e8 5d fc ff ff       	call   80104940 <argint>
...
80104cf0:	e8 9b ec ff ff       	call   80103990 <myproc>
...
80104d38:	e8 63 c1 ff ff       	call   80100ea0 <filedup>
  return fd;
...
80104d5e:	e8 dd fb ff ff       	call   80104940 <argint>
...
80104d89:	e8 b2 fb ff ff       	call   80104940 <argint>
...
80104d9e:	e8 ed fb ff ff       	call   80104990 <argptr>
...
80104db4:	e8 67 c2 ff ff       	call   80101020 <fileread>
...
80104dde:	e8 5d fb ff ff       	call   80104940 <argint>
...
80104e09:	e8 32 fb ff ff       	call   80104940 <argint>
...
80104e1e:	e8 6d fb ff ff       	call   80104990 <argptr>
...
80104e81:	74 25                	je     80104ea8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80104e83:	e8 08 eb ff ff       	call   80103990 <myproc>
  fileclose(f);
...
80104ebe:	e8 7d fa ff ff       	call   80104940 <argint>
...
80104ee8:	e8 a3 fa ff ff       	call   80104990 <argptr>
...
80104f2f:	e8 cc fa ff ff       	call   80104a00 <argstr>
...
80104f48:	e8 b3 fa ff ff       	call   80104a00 <argstr>
...
8010507f:	e8 7c f9 ff ff       	call   80104a00 <argstr>
...
801050bd:	58                   	pop    %eax
801050be:	5a                   	pop    %edx
801050bf:	68 58 7a 10 80       	push   $0x80107a58
...
801050d8:	68 57 7a 10 80       	push   $0x80107a57
...
80105132:	e8 49 f5 ff ff       	call   80104680 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
8010525f:	e8 9c f7 ff ff       	call   80104a00 <argstr>
...
80105278:	e8 c3 f6 ff ff       	call   80104940 <argint>
...
801052c7:	74 23                	je     801052ec <sys_open+0x9c>
  struct proc *curproc = myproc();
801052c9:	e8 c2 e6 ff ff       	call   80103990 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801053a4:	e8 57 f6 ff ff       	call   80104a00 <argstr>
...
80105404:	e8 f7 f5 ff ff       	call   80104a00 <argstr>
...
80105419:	e8 22 f5 ff ff       	call   80104940 <argint>
  if((argstr(0, &path)) < 0 ||
...
80105485:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105488:	e8 03 e5 ff ff       	call   80103990 <myproc>
...
8010549d:	e8 5e f5 ff ff       	call   80104a00 <argstr>
...
80105545:	e8 b6 f4 ff ff       	call   80104a00 <argstr>
...
80105561:	e8 da f3 ff ff       	call   80104940 <argint>
...
80105580:	e8 fb f0 ff ff       	call   80104680 <memset>
...
801055aa:	e8 01 f3 ff ff       	call   801048b0 <fetchint>
...
801055c8:	e8 23 f3 ff ff       	call   801048f0 <fetchstr>
...
80105631:	e8 5a f3 ff ff       	call   80104990 <argptr>
...
80105657:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105659:	e8 32 e3 ff ff       	call   80103990 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
{
  return fork();
801056f0:	e9 3b e4 ff ff       	jmp    80103b30 <fork>
...
80105703:	83 ec 08             	sub    $0x8,%esp
  exit();
80105706:	e8 a5 e6 ff ff       	call   80103db0 <exit>
...
{
  return wait();
80105710:	e9 cb e7 ff ff       	jmp    80103ee0 <wait>
...
8010573e:	e8 3d ea ff ff       	call   80104180 <kill>
...
80105763:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105766:	e8 25 e2 ff ff       	call   80103990 <myproc>
...
80105787:	78 27                	js     801057b0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105789:	e8 02 e2 ff ff       	call   80103990 <myproc>
  if(growproc(n) < 0)
...
80105796:	e8 15 e3 ff ff       	call   80103ab0 <growproc>
...
801057e0:	68 80 3e 11 80       	push   $0x80113e80
801057e5:	e8 d6 ed ff ff       	call   801045c0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801057ea:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801057ed:	8b 1d 60 3e 11 80    	mov    0x80113e60,%ebx
  while(ticks - ticks0 < n){
...
80105803:	68 80 3e 11 80       	push   $0x80113e80
80105808:	68 60 3e 11 80       	push   $0x80113e60
8010580d:	e8 4e e8 ff ff       	call   80104060 <sleep>
  while(ticks - ticks0 < n){
80105812:	a1 60 3e 11 80       	mov    0x80113e60,%eax
...
80105835:	e8 26 ed ff ff       	call   80104560 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105858:	e8 03 ed ff ff       	call   80104560 <release>
  return 0;
...
80105874:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105877:	68 80 3e 11 80       	push   $0x80113e80
8010587c:	e8 3f ed ff ff       	call   801045c0 <acquire>
  xticks = ticks;
80105881:	8b 1d 60 3e 11 80    	mov    0x80113e60,%ebx
  release(&tickslock);
80105887:	c7 04 24 80 3e 11 80 	movl   $0x80113e80,(%esp)
8010588e:	e8 cd ec ff ff       	call   80104560 <release>
  return xticks;
}
...
801058a4:	83 ec 14             	sub    $0x14,%esp
  int arg;
  struct proc *p = myproc();
801058a7:	e8 e4 e0 ff ff       	call   80103990 <myproc>
...
801058b7:	e8 84 f0 ff ff       	call   80104940 <argint>

    p->tracing = arg;
    return -1;
801058bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058bf:	89 43 7c             	mov    %eax,0x7c(%ebx)
  }
...
80105907:	c7 04 c5 c2 3e 11 80 	movl   $0x8e000008,-0x7feec13e(,%eax,8)
8010590e:	08 00 00 8e 
80105912:	66 89 14 c5 c0 3e 11 	mov    %dx,-0x7feec140(,%eax,8)
80105919:	80 
8010591a:	c1 ea 10             	shr    $0x10,%edx
8010591d:	66 89 14 c5 c6 3e 11 	mov    %dx,-0x7feec13a(,%eax,8)
80105924:	80 
  for(i = 0; i < 256; i++)
...
80105937:	c7 05 c2 40 11 80 08 	movl   $0xef000008,0x801140c2
8010593e:	00 00 ef 
  initlock(&tickslock, "time");
80105941:	68 40 79 10 80       	push   $0x80107940
80105946:	68 80 3e 11 80       	push   $0x80113e80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010594b:	66 a3 c0 40 11 80    	mov    %ax,0x801140c0
80105951:	c1 e8 10             	shr    $0x10,%eax
80105954:	66 a3 c6 40 11 80    	mov    %ax,0x801140c6
  initlock(&tickslock, "time");
8010595a:	e8 91 ea ff ff       	call   801043f0 <initlock>
}
...
8010597b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010597f:	b8 c0 3e 11 80       	mov    $0x80113ec0,%eax
...
801059c4:	ff 24 85 40 7b 10 80 	jmp    *-0x7fef84c0(,%eax,4)
...
801059e3:	e8 a8 df ff ff       	call   80103990 <myproc>
...
80105a00:	e8 8b df ff ff       	call   80103990 <myproc>
80105a05:	85 c0                	test   %eax,%eax
80105a07:	74 0f                	je     80105a18 <trap+0x78>
80105a09:	e8 82 df ff ff       	call   80103990 <myproc>
...
80105a12:	0f 84 b8 00 00 00    	je     80105ad0 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a18:	e8 73 df ff ff       	call   80103990 <myproc>
80105a1d:	85 c0                	test   %eax,%eax
80105a1f:	74 1d                	je     80105a3e <trap+0x9e>
80105a21:	e8 6a df ff ff       	call   80103990 <myproc>
...
80105a50:	e8 3b df ff ff       	call   80103990 <myproc>
...
80105a70:	e8 fb de ff ff       	call   80103970 <cpuid>
...
80105a81:	e8 0a df ff ff       	call   80103990 <myproc>
...
80105aa5:	68 fc 7a 10 80       	push   $0x80107afc
80105aaa:	e8 f1 ab ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105aaf:	83 c4 20             	add    $0x20,%esp
80105ab2:	e8 d9 de ff ff       	call   80103990 <myproc>
80105ab7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105abe:	e8 cd de ff ff       	call   80103990 <myproc>
...
80105ad4:	0f 85 3e ff ff ff    	jne    80105a18 <trap+0x78>
    yield();
80105ada:	e8 31 e5 ff ff       	call   80104010 <yield>
...
80105aef:	e8 7c de ff ff       	call   80103970 <cpuid>
80105af4:	57                   	push   %edi
80105af5:	56                   	push   %esi
80105af6:	50                   	push   %eax
80105af7:	68 a4 7a 10 80       	push   $0x80107aa4
...
80105b35:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105b38:	e8 43 ef ff ff       	call   80104a80 <syscall>
    if(myproc()->killed)
...
80105b53:	5d                   	pop    %ebp
      exit();
80105b54:	e9 57 e2 ff ff       	jmp    80103db0 <exit>
...
80105b65:	e8 a6 cd ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b6a:	e8 21 de ff ff       	call   80103990 <myproc>
...
80105bb0:	68 80 3e 11 80       	push   $0x80113e80
80105bb5:	e8 06 ea ff ff       	call   801045c0 <acquire>
      wakeup(&ticks);
80105bba:	c7 04 24 60 3e 11 80 	movl   $0x80113e60,(%esp)
      ticks++;
80105bc1:	83 05 60 3e 11 80 01 	addl   $0x1,0x80113e60
      wakeup(&ticks);
80105bc8:	e8 53 e5 ff ff       	call   80104120 <wakeup>
      release(&tickslock);
80105bcd:	c7 04 24 80 3e 11 80 	movl   $0x80113e80,(%esp)
80105bd4:	e8 87 e9 ff ff       	call   80104560 <release>
...
{
  if(!uart)
80105c30:	a1 c0 46 11 80       	mov    0x801146c0,%eax
...
80105cb7:	74 78                	je     80105d31 <uartinit+0xd1>
  uart = 1;
80105cb9:	c7 05 c0 46 11 80 01 	movl   $0x1,0x801146c0
80105cc0:	00 00 00 
...
80105ccc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105ccf:	bf c0 7b 10 80       	mov    $0x80107bc0,%edi
...
80105d40 <uartputc>:
  if(!uart)
80105d40:	a1 c0 46 11 80       	mov    0x801146c0,%eax
...
80106975:	e8 06 dd ff ff       	call   80104680 <memset>
...
801069bd:	68 c8 7b 10 80       	push   $0x80107bc8
...
801069d3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801069d6:	e8 95 cf ff ff       	call   80103970 <cpuid>
  pd[0] = size-1;
...
80106a60:	a1 c4 46 11 80       	mov    0x801146c4,%eax
...
80106a94:	0f 84 c2 00 00 00    	je     80106b5c <switchuvm+0xec>
  pushcli();
80106a9a:	e8 d1 d9 ff ff       	call   80104470 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106a9f:	e8 6c ce ff ff       	call   80103910 <mycpu>
80106aa4:	89 c3                	mov    %eax,%ebx
80106aa6:	e8 65 ce ff ff       	call   80103910 <mycpu>
80106aab:	89 c7                	mov    %eax,%edi
80106aad:	e8 5e ce ff ff       	call   80103910 <mycpu>
80106ab2:	83 c7 08             	add    $0x8,%edi
80106ab5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106ab8:	e8 53 ce ff ff       	call   80103910 <mycpu>
...
80106be2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106be3:	e9 38 db ff ff       	jmp    80104720 <memmove>
    panic("inituvm: more than a page");
80106be8:	83 ec 0c             	sub    $0xc,%esp
80106beb:	68 0d 7c 10 80       	push   $0x80107c0d
...
80106c50:	68 27 7c 10 80       	push   $0x80107c27
...
80106cd8:	68 c8 7c 10 80       	push   $0x80107cc8
...
80106d79:	68 45 7c 10 80       	push   $0x80107c45
...
80106ddb:	68 5d 7c 10 80       	push   $0x80107c5d
...
80106ebc:	68 79 7c 10 80       	push   $0x80107c79
...
80106f5b:	a3 c4 46 11 80       	mov    %eax,0x801146c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106f8c:	68 8a 7c 10 80       	push   $0x80107c8a
...
80107002:	68 94 7c 10 80       	push   $0x80107c94
...
80107060:	e8 bb d6 ff ff       	call   80104720 <memmove>
...
801070d7:	68 ae 7c 10 80       	push   $0x80107cae
...
80107190:	e8 8b d5 ff ff       	call   80104720 <memmove>
    len -= n;
    buf += n;
