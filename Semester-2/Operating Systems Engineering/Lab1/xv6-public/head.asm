...
int main(int argc, char *argv[]) {
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	push   (%ebx)
  37:	e8 a7 03 00 00       	call   3e3 <open>
  ...
  4b:	83 c3 04             	add    $0x4,%ebx
    head(fd);
  4e:	50                   	push   %eax
  4f:	e8 3c 00 00 00       	call   90 <head>
    close(fd);
  54:	89 3c 24             	mov    %edi,(%esp)
  57:	e8 6f 03 00 00       	call   3cb <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  64:	e8 3a 03 00 00       	call   3a3 <exit>
      printf(1, "head: cannot open %s\n", argv[i]);
  69:	50                   	push   %eax
  6a:	ff 33                	push   (%ebx)
  ...
  73:	e8 88 04 00 00       	call   500 <printf>
      exit();
  78:	e8 26 03 00 00       	call   3a3 <exit>
    head(0);
  7d:	83 ec 0c             	sub    $0xc,%esp
  80:	6a 00                	push   $0x0
  82:	e8 09 00 00 00       	call   90 <head>
    exit();
  87:	e8 17 03 00 00       	call   3a3 <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
  ...
  94:	31 ff                	xor    %edi,%edi
{
  ...
  a3:	68 00 02 00 00       	push   $0x200
  a8:	68 c0 0b 00 00       	push   $0xbc0
  ad:	ff 75 08             	push   0x8(%ebp)
  b0:	e8 06 03 00 00       	call   3bb <read>
  b5:	83 c4 10             	add    $0x10,%esp
  b8:	89 c6                	mov    %eax,%esi
  ba:	85 c0                	test   %eax,%eax
  bc:	7e 72                	jle    130 <head+0xa0>
  be:	83 ff 0a             	cmp    $0xa,%edi
  c1:	74 6f                	je     132 <head+0xa2>
    for (int i = 0; i < n && count < 10; i++) {
  c3:	31 db                	xor    %ebx,%ebx
  c5:	eb 38                	jmp    ff <head+0x6f>
  c7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ce:	66 90                	xchg   %ax,%ax
      printf(1, "%c", buf[i]);
  d0:	0f be 83 c0 0b 00 00 	movsbl 0xbc0(%ebx),%eax
  ...
  ec:	80 bb c0 0b 00 00 0a 	cmpb   $0xa,0xbc0(%ebx)
  f3:	0f 94 c0             	sete   %al
    for (int i = 0; i < n && count < 10; i++) {
  f6:	83 c3 01             	add    $0x1,%ebx
      if (buf[i] == '\n') count++;
  f9:	01 c7                	add    %eax,%edi
    for (int i = 0; i < n && count < 10; i++) {
  fb:	39 de                	cmp    %ebx,%esi
  fd:	7e 05                	jle    104 <head+0x74>
  ff:	83 ff 09             	cmp    $0x9,%edi
 102:	7e cc                	jle    d0 <head+0x40>
    if (write(1, buf, n) != n) {
 104:	83 ec 04             	sub    $0x4,%esp
 107:	56                   	push   %esi
 108:	68 c0 0b 00 00       	push   $0xbc0
 10d:	6a 01                	push   $0x1
 10f:	e8 af 02 00 00       	call   3c3 <write>
 114:	83 c4 10             	add    $0x10,%esp
 117:	39 f0                	cmp    %esi,%eax
 119:	74 85                	je     a0 <head+0x10>
      printf(1, "head: write error\n");
 11b:	83 ec 08             	sub    $0x8,%esp
 11e:	68 2b 08 00 00       	push   $0x82b
 123:	6a 01                	push   $0x1
 125:	e8 d6 03 00 00       	call   500 <printf>
      exit();
 12a:	e8 74 02 00 00       	call   3a3 <exit>
 12f:	90                   	nop
  if(n < 0){
 130:	75 08                	jne    13a <head+0xaa>
}
 ...
 13a:	50                   	push   %eax
 13b:	50                   	push   %eax
 13c:	68 3e 08 00 00       	push   $0x83e
 141:	6a 01                	push   $0x1
 143:	e8 b8 03 00 00       	call   500 <printf>
    exit();
 148:	e8 56 02 00 00       	call   3a3 <exit>
 ...
 509:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 687:	90                   	nop
          s = "(null)";
 688:	ba 66 08 00 00       	mov    $0x866,%edx
        while(*s != 0){
